...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # basic parameters
        parser.add_argument('--dataroot', default='rootfile', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='thermal', help='chooses which model to use.')
    ...
    def gather_options(self):
        ...
        model_option_setter = trainmodels.get_option_setter(model_name)
        ...
        dataset_option_setter = loaddata.get_option_setter(dataset_name)
