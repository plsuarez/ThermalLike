...
class TrainOptions(BaseOptions):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--evaluation_freq', type=int, default=500, help='evaluation freq')
        ...
        parser.add_argument('--beta1', type=float, default=0.95, help='momentum term of adam')
        parser.add_argument('--beta2', type=float, default=0.999, help='momentum term of adam')
        parser.add_argument('--lr', type=float, default=0.000262365, help='initial learning rate for adam')
